...
describe("when there is initially one user in db", () => {
  ...
  test("creation fails with proper statuscode and message if username is shorter than the minimum allowed length", async () => {
    const usersAtStart = await usersInDb();
  ...
  test("creation fails with proper statuscode and message if password is shorter than the minimum allowed length", async () => {
    const usersAtStart = await usersInDb();
